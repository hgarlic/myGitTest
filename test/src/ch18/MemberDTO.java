...
//객체 직렬화는 메모리에 저장된 객체를 파일로 저장하거나 네트워크를 통해 전송할 때 사용

//MVC패턴에서 쓰이는 용어
//1)DTO : Data Transfer Object(데이터를 전달하는 객체, 결과물을 저장)
//2)VO : Value Object, DTO의 개념과 같지만 VO의 경우 생성자를 안쓰고 getter, setter 사용안함
//3)DAO : Data Access Object(데이터 조작 객체, DB와 프로그램을 연결해서 데이터를 구하거나 조작하는 비즈니스 로직단)
